...
public class RedisUtil {
     ...
     * @return
     */
    public double HashCre(String key, String item,double by){
     ...
     * @return
     */
    public double HashDre(String key, String item,double by){
        return redisTemplate.opsForHash().increment(key, item,-by);
    }
     ...
     * @return true 存在 false不存在
     */
    public boolean HashIsNUll(String key,Object value){
        try {
